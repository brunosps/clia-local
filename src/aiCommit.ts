...
export function buildCommitMessagePrompt(diff: string, options: CommitPromptOptions = {}): string {
  ...
  return [
    ...
    "6. SEMPRE escreva um corpo (descrição) após uma linha em branco — não entregue só o subject.",
    "",
    "Como escrever o corpo (descrição):",
    "- Use de 2 a 5 bullets começando com `- `, objetivos e concretos.",
    "- Diga O QUE mudou (funções, queries, condições, regras) E o impacto/porquê prático.",
    "- Cite identificadores reais do diff (nomes de função, tabela, coluna, parâmetro, condição) quando ajudar a entender.",
    "- Acrescente um footer `BREAKING CHANGE: ...` se houver quebra de compatibilidade.",
    "- Só é aceitável omitir o corpo se a mudança for trivial de UMA linha (ex.: typo ou formatação).",
    "",
    "Critérios de qualidade:",
    "- Explique O QUE mudou e, no corpo, o impacto prático.",
    ...
    "",
    "Formato de resposta:",
    "Responda SOMENTE com a mensagem de commit, sem cercas de código (```), sem aspas, sem explicação e sem rótulos `Subject:`/`Description:`.",
    "Estrutura exata:",
    "`type(scope): resumo específico`",
    "",
    "`- bullet do que mudou e o impacto`",
    "`- outro bullet concreto`",
    "",
    "Arquivos staged:",
    files,
    "",
